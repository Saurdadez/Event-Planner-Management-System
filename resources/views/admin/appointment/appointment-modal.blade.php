<!-- ADD CLIENT MODAL -->
<div class="modal fade text-left" id="addAppointment" tabindex="-1" role="dialog" aria-labelledby="addAppointmentModal"
    aria-hidden="true">
        ...
        <div class="modal-content">
            <form class="form form-vertical" method="POST" enctype="multipart/form-data" name="add"
                ...
                <div class="modal-header bg-primary d-flex align-items-center justify-content-between">
                    <h5 class="modal-title text-white">New Appointment</h5>
